...
subtitle: "Graduate Reading Group — UC Berkeley — Spring 2025"
format:
  html:
    theme: cosmo
    toc: true
...
| 3 | Interpretability as Safety Strategy | [A Pragmatic Vision for Interpretability](https://www.alignmentforum.org/posts/StENzDcD3kpfGJssR/a-pragmatic-vision-for-interpretability) + [How Can Interpretability Researchers Help AGI Go Well?](https://www.alignmentforum.org/posts/MnkeepcGirnJn736j/how-can-interpretability-researchers-help-agi-go-well) — Nanda (2023) |
| 4 | Causal Intervention in Practice | [Locating and Editing Factual Associations in Transformers](https://arxiv.org/abs/2401.01967) — Meng et al. (2024) |

### Part II: Intervention, Control, and Robustness (Weeks 5–11)

| Week | Topic | Reading |
|------|-------|---------|
| 5 | Steering Vectors | [Steering GPT-2-XL by Adding Directions in Activation Space](https://arxiv.org/abs/2303.11396) — Turner et al. (2023) |
| 6 | Stability of Steering | Layer-Wise Stability of Steering Vectors — Li et al. (2024) |
| 7 | Machine Unlearning | [Unlearning Dangerous Capabilities in Language Models](https://arxiv.org/abs/2301.10728) — Maini et al. (2024) |
| 8 | Latent Knowledge | [Discovering Latent Knowledge in Language Models Without Supervision](https://arxiv.org/abs/2306.11644) — Burns et al. (2023) |
| 9 | Context-Dependent Representations | Prompted Representations — Miller et al. (2024) |
| 10 | Evaluating Interpretability | [A Framework for Benchmarking Methods](https://arxiv.org/abs/2303.16812) — Casper et al. (2024) |
| 11 | Causal Scrubbing | [Interventions for Mechanistic Interpretability](https://arxiv.org/abs/2301.13163) — Chan et al. (2023) |

### Part III: Failure Modes, Explanation, and Alignment (Weeks 12–15)

| Week | Topic | Reading |
|------|-------|---------|
| 12 | Mesa-Optimization | [Risks from Learned Optimization in Advanced ML Systems](https://arxiv.org/abs/1906.01820) — Hubinger et al. (2019) |
| 13 | Interpretability Under Deception | Mechanistic Interpretability Can Fail in the Presence of Deception — Barnett et al. (2024) |
| 14 | Philosophy of Causal Explanation | *Making Things Happen*, selected chapters — Woodward (2003) |
